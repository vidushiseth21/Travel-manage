<?php
  ...
  { 
    ...
    {
      foreach ($seats as $seat) {
      $sql = "insert into seat_info_train (seat_num, train_id, status) values ('$seat', '$trainId', 'checked')";
    ...
    $sql = "update train_trips set avai_seat = avai_seat-$count where train_id=$trainId;";
     ...
     //*****************//
      ...
      $sql1 = "insert into ticket_invoice (user_name, email, phone, gender,train_id,vehicle_name, pay_method, amount, seats, category, route, jdate, jtime) values ('$fname', '$email','$phone','$gender','$trainId','$v_name','$payment','$amount','$seatNum','$category','$route','$jdate','$jtime');";
            ...
            <tr>
                ...
                <td>
                  <select name="payMethod" required>
                      ...
                      <option value="IntenerBanking">Internet Banking</option>
