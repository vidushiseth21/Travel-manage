...
<body>
    ...
    <center> 
      ...
      <table border="1" style="width: 40%">
        ...
        <tr>
          <th>Flight#: </th>
          <td><?php echo $_SESSION["flight_id"] ?></td>
        </tr>
        <tr>
          <th>Your Name: </th>
      ...
      <a href="flight_t_print.php"><h3 style="background-color: green;border: none;color: white; font-size: 20px;display: inline-block;">Print Your Ticket</h3></a>
