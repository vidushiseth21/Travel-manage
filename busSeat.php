<?php
	...
	$sql = "select * from seat_info_bus where bus_id = '$busId';";
	...
	{	$_SESSION["seats"] = $_POST["seats"];
        $_SESSION["bb"] = "on";
		header('Location: busFare.php'); //.urlencode(serialize($_POST["seats"])));
		exit();
	}
...
<hr style="background-color: black;border: 2px ridge black; width: 396px;"/>
  <table>
       <tr>
 ...
 <table>
  ...
  <table>
       <tr>
        ...
        <td><input type="checkbox" id="I2" name="seats[]" value="I2" onchange="document.getElementById('checkBtn').disabled = !this.checked;" <?php echo $i2; ?> /><label for="I2" class="seat"><span></span>I2</label></td>
        <td> &nbsp; </td><td><div class="vertical-line" style="height: 70px;" /></td><td> &nbsp; </td>
        </td><td> &nbsp; </td></td><td> &nbsp; </td>
        <td> &nbsp; </td><td><div class="vertical-line" style="height: 70px;" /></td><td> &nbsp; </td>
        <td><input type="checkbox" id="I3" name="seats[]" value="I3" onchange="document.getElementById('checkBtn').disabled = !this.checked;" <?php echo $i3; ?> /><label for="I3" class="seat"><span></span>I3</label></td><td> &nbsp; </td><td> &nbsp; </td>
        <td><input type="checkbox" id="I4" name="seats[]" value="I4" onchange="document.getElementById('checkBtn').disabled = !this.checked;" <?php echo $i4; ?> /><label for="I4" class="seat"><span></span>I4</label></td>
        <td> &nbsp; </td><td><div class="vertical-line" style="height: 70px;" /></td><td> &nbsp; </td>
       </tr>
  </table>
  <table>
       <tr>
        ...
        <td><input type="checkbox" id="J3" name="seats[]" value="J3" onchange="document.getElementById('checkBtn').disabled = !this.checked;" <?php echo $j3; ?> /><label for="J3" class="seat"><span></span>J3</label></td></td><td> &nbsp; </td>
        ...
        <td><input type="checkbox" id="J5" name="seats[]" value="J5" onchange="document.getElementById('checkBtn').disabled = !this.checked;" <?php echo $j5; ?> /><label for="J5" class="seat"><span></span>J5</label></td>
        <td> &nbsp; </td><td><div class="vertical-line" style="height: 70px;" /></td><td> &nbsp; </td>
       </tr>
  </table>
   <hr style="background-color: black;border: 2px ridge black; width: 396px;"/>
