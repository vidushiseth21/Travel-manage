<?php
	...
	{	$_SESSION["seats"] = $_POST["seats"];
	 	$_SESSION["ff"] = "on";
		header('Location: flightFare.php'); //.urlencode(serialize($_POST["seats"])));
		exit();
	}
...
<input type="submit" id="checkBtn" value="Continue" style="background-color: 728FCE; color: white; font-size: 20px;"/>
</form>
</center>
</br> </br>
<div class="footer">
